...
const AesopGame = ({ gameContent, title }) => {
  // Game state
    ...
    <div className="flex flex-col items-center mx-auto max-w-3xl p-6 bg-blue-50 rounded-lg shadow-md">
      ...
      {!gameComplete ? (
        ...
        <div className="text-center bg-white p-8 rounded-lg shadow-sm w-full">
          ...
          <p className="text-lg mb-2">{currentContent.text}</p>
          <p className="text-xl font-medium text-blue-700 mb-6">{currentContent.moral}</p>
          <div className="mb-6">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a
              href="/"
              className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg inline-block"
            >
              Try Another Story
            </a>
          </div>
...
// Set default props
AesopGame.defaultProps = {
  title: "Aesop's Fable Visualization Game"
};

export default AesopGame;